...
export function IphoneMockup({
  ...
  return (
    <div className={` ${className}`}>
      ...
      {/* Device Frame */}
      <div className=" flex h-[840px]  items-center justify-center overflow-clip  relative rounded-[54px] shadow-[0px_0px_0px_2px_var(--device-frame-outer),0px_0px_0px_4px_var(--device-frame-inner)] shrink-0 w-[390px] max-w-[98vw] scale-[0.9] sm:scale-100 transform origin-center">
        <div
          aria-hidden="true"
