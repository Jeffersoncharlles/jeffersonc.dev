...
const imgContainer =
  "https://www.figma.com/api/mcp/asset/7058877a-167f-41cf-961f-62869d4fb7de";
const imgContainer1 =
  "https://www.figma.com/api/mcp/asset/a699c152-125a-4ceb-bb1d-15a6b806d82f";
const imgContainerMobile =
  "https://www.figma.com/api/mcp/asset/6f643e0d-1ca6-46d6-8d1a-7bee08739568";
const imgContainer1Mobile =
  "https://www.figma.com/api/mcp/asset/740a71a1-7c7f-4aa7-8aee-0bcbb3e7f719";
...
function BlogDesktop() {
  return (
    <div className="hidden md:flex bg-blog-bg content-stretch flex-col items-start relative size-full min-h-screen">
      <div className="content-stretch flex flex-col gap-[96px] lg:gap-[160px] items-center py-[120px] lg:py-[160px] relative shrink-0 w-full">
        <div className="content-stretch flex flex-col gap-[56px] lg:gap-[80px] items-start max-w-[896px] px-[24px] lg:px-[32px] relative shrink-0 w-full md:max-w-[736px] lg:w-[896px] lg:max-w-[896px]">
            ...
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] w-full">
                <p className="leading-[24px]">
                  Deep dives into the intersection of design and philosophy.
                </p>
              </div>
            </div>
          </div>
          <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-full">
            <div className="border-[rgba(68,71,90,0.1)] border-b border-solid content-stretch flex flex-col gap-[16px] items-start pb-[65px] relative shrink-0 w-full">
                ...
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
                  <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f8f8f2] text-[36px] w-full">
                    <p>
                      ...
                      <span
                        className="bg-clip-text font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[45px] text-[transparent]"
                        style={{
                          backgroundImage:
                            "linear-gradient(171.40189672827162deg, rgb(189, 147, 249) 0%, rgb(255, 121, 198) 100%)",
                        }}
                      >
                        Silence
                      </span>
              ...
              <div className="max-w-[672px] relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] relative w-full">
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[59px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[18px] w-[662.94px]">
                    <p className="leading-[29.25px] mb-0">
                      Exploring the psychological impact of minimalist spaces in
                      a hyper-connected
                    </p>
                    <p className="leading-[29.25px]">
                      world. How emptiness fuels creativity and focus in an age
                      of constant noise.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] relative w-full">
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[52px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] w-[671.47px]">
                    <p className="leading-[26px] mb-0">
                      How functional programming principles are influencing
                      modern interface design systems
                    </p>
                    <p className="leading-[26px]">
                      for better performance and cognitive clarity.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-[672px] relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] relative w-full">
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[52px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] w-[655.14px]">
                    <p className="leading-[26px] mb-0">
                      Navigating the transition states between user actions and
                      the psychological comfort of
                    </p>
                    <p className="leading-[26px]">
                      loading sequences in modern web apps.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="border-[rgba(68,71,90,0.1)] border-b border-solid content-stretch flex flex-col gap-[16px] items-start pb-[65px] relative shrink-0 w-full">
              ...
              <div className="relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
                  <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f8f8f2] text-[30px] w-full">
                    <p className="leading-[37.5px]">
                      Dark Mode as a Design First Principle
                    </p>
                  </div>
                </div>
              </div>
              <div className="max-w-[672px] relative shrink-0 w-full">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] relative w-full">
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[52px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] w-[602.66px]">
                    <p className="leading-[26px] mb-0">
                      Why the future of software design is moving towards
                      low-light environments for
                    </p>
                    <p className="leading-[26px]">
                      sustained focus and eye health in long-form work sessions.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-blog-card-bg border border-[rgba(255,255,255,0.05)] border-solid content-stretch flex flex-col gap-[16px] items-start pb-[65px] pt-[49px] px-[24px] md:px-[32px] lg:px-[49px] relative rounded-[24px] shrink-0 w-full md:max-w-[736px] lg:w-[832px] lg:max-w-[832px]">
          <div className="relative shrink-0 w-full">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
              <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#f8f8f2] text-[30px] tracking-[-1.5px] w-full">
                <p>
                  ...
                  <span className="font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[36px] text-dracula-purple">
                    Inner Circle
                  </span>
          ...
          <div className="max-w-[448px] relative shrink-0 w-[448px]">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start max-w-[inherit] relative w-full">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] w-[437.5px]">
                <p className="leading-[24px]">
                  Weekly editorial insights on design, code, and philosophy.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <div className="bg-blog-footer-bg border-[rgba(255,255,255,0.05)] border-solid border-t content-stretch flex flex-col items-center justify-center pb-[80px] pt-[81px] px-[24px] md:px-[48px] lg:px-[192px] relative shrink-0 w-full">
        <div className="max-w-[896px] relative shrink-0 w-full">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between max-w-[inherit] px-[32px] relative w-full">
            <div className="content-stretch flex flex-col gap-[8px] items-start leading-[0] relative shrink-0">
              <Link
                href="/"
                className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[32px] justify-center relative shrink-0 text-dracula-purple text-[24px] tracking-[-1.2px] hover:opacity-80 transition-opacity"
              >
            ...
            <div className="bg-blog-card-bg content-stretch flex items-center justify-center relative rounded-[12px] shrink-0 size-[40px] border border-white/5 cursor-pointer hover:opacity-80 transition-opacity">
              <div className="relative shrink-0 size-[9.333px]">
                <img
                  alt=""
                  className="absolute block max-w-none size-full opacity-60"
                  src={imgContainer}
                />
              </div>
            </div>
          ...
          <div className="relative shrink-0">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[32px] items-center relative">
              <div className="content-stretch flex flex-col items-start relative shrink-0">
                <Link
                  href="/"
                  className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] relative shrink-0 text-dracula-purple text-[20px] tracking-[-1px] w-[87.48px] hover:opacity-80 transition-opacity"
                >
              ...
              <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
                <Link
                  href="/"
                  className="content-stretch flex flex-col items-start px-[16px] py-[8px] relative rounded-[12px] shrink-0 hover:bg-white/5 transition-colors cursor-pointer"
                >
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative">
              ...
              <div className="content-stretch flex items-center justify-center p-[8px] relative rounded-[12px] shrink-0 hover:bg-white/5 transition-colors cursor-pointer">
                <div className="relative shrink-0 size-[18px]">
                  <img
                    alt=""
                    className="absolute block max-w-none size-full opacity-70"
                    src={imgContainer1}
                  />
                </div>
              </div>
...
function BlogMobile() {
  return (
    <div className="flex md:hidden bg-blog-mobile-bg content-stretch flex-col items-start relative size-full min-h-screen">
      <div className="content-stretch flex flex-col gap-[64px] items-center max-w-[672px] pb-[96px] pt-[112px] px-[24px] relative shrink-0 w-full z-10 mx-auto">
        <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
            <div className="flex flex-col font-['Space_Grotesk:Bold',sans-serif] font-bold h-[120px] justify-center leading-[0] relative shrink-0 text-[#f8f8f2] text-[48px] text-center tracking-[-2.4px] w-[278.36px]">
              ...
              <p
                className="bg-clip-text leading-[60px] text-[transparent]"
                style={{
                  backgroundImage:
                    "linear-gradient(121.37952886094178deg, rgb(189, 147, 249) 0%, rgb(255, 121, 198) 100%)",
                }}
              >
                Chronicles.
              </p>
          ...
          <div className="content-stretch flex flex-col items-center max-w-[448px] opacity-80 pt-[8px] relative shrink-0 w-full mx-auto">
            <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[52px] justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[16px] text-center w-full max-w-[279.33px]">
              <p className="leading-[26px] mb-0">
                A minimalist exploration of functional
              </p>
              <p className="leading-[26px]">
                aesthetics and digital craftsmanship.
              </p>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[10.8px] items-start relative shrink-0 w-[92%] max-w-[560px] self-center">
            ...
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[14px] w-full">
                <p className="leading-[22.75px] mb-0">
                  How stripping away the noise from your codebase
                </p>
                <p className="leading-[22.75px] mb-0">
                  mirrors the minimalist movement in mid-century
                </p>
            ...
            <div className="content-stretch flex gap-[8px] items-center pt-[5.2px] relative shrink-0 cursor-pointer hover:opacity-80 transition-opacity">
              ...
              <div className="relative shrink-0 size-[9.333px]">
                <img
                  alt=""
                  className="absolute block max-w-none size-full opacity-60"
                  src={imgContainerMobile}
                />
              </div>
            </div>
          </div>
          <div className="bg-[rgba(68,71,90,0.1)] h-px shrink-0 w-[92%] max-w-[560px] self-center" />
          <div className="content-stretch flex flex-col gap-[10.8px] items-start relative shrink-0 w-[92%] max-w-[560px] self-center">
            <div className="content-stretch flex gap-[16px] items-center opacity-60 relative shrink-0 w-full">
              <div className="content-stretch flex flex-col items-start relative shrink-0">
            ...
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[14px] w-full">
                <p className="leading-[22.75px] mb-0">
                  Why intentional imbalance creates a more
                </p>
                <p className="leading-[22.75px] mb-0">
                  engaging user journey than traditional symmetrical
                </p>
          ...
          <div className="content-stretch flex flex-col gap-[10.8px] items-start relative shrink-0 w-[92%] max-w-[560px] self-center">
            ...
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#bfbfbf] text-[14px] w-full">
                <p className="leading-[22.75px] mb-0">
                  Searching for the perfect mechanical switch to
                </p>
                <p className="leading-[22.75px] mb-0">
                  complement a dark mode workflow and enhance
                </p>
          ...
          <div className="content-stretch flex flex-col gap-[32px] items-start pt-[48px] relative shrink-0 w-[92%] max-w-[560px] self-center">
      ...
      <div className="fixed backdrop-blur-[12px] bg-[rgba(40,42,54,0.8)] border-white/5 border-b border-solid content-stretch flex flex-col items-start left-1/2 -translate-x-1/2 pb-px top-0 w-[calc(100%-16px)] max-w-[672px] z-50">
        <div className="h-[64px] max-w-[672px] mx-auto relative shrink-0 w-full">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between max-w-[inherit] px-[24px] relative size-full">
            <div className="content-stretch flex flex-col items-start relative shrink-0">
              <Link
                href="/"
                className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-dracula-purple text-[18px] tracking-[-0.9px] w-[80.77px] hover:opacity-80 transition-opacity"
              >
                <p className="leading-[28px]">jeffersonc</p>
              </Link>
            </div>
