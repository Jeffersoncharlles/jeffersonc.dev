    ...
    <header className="h-10 md:h-11 bg-white/5 border-b border-white/5 flex items-center justify-between px-3 md:px-6 shrink-0 z-10 relative">
      ...
      <div className="flex items-center gap-2 md:gap-6 min-w-0">
        ...
        <div className="hidden md:flex items-center gap-2 shrink-0">
          <div className="w-3 h-3 rounded-full bg-[#ff5555] shadow-[0_4px_6px_-4px_rgba(239,68,68,0.2)]"></div>
          <div className="w-3 h-3 rounded-full bg-[#ffb86c] shadow-[0_4px_6px_-4px_rgba(249,115,22,0.2)]"></div>
          <div className="w-3 h-3 rounded-full bg-[#50fa7b] shadow-[0_4px_6px_-4px_rgba(34,197,94,0.2)]"></div>
        </div>
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[11px] md:text-[12px] font-medium text-foreground/80 tracking-[0.3px] opacity-60 truncate max-w-55 md:max-w-none">
            ESTRUTURA DE PROJETO: NEXT.JS + CLEAN ARCHITECTURE
          </span>
        </div>
      </div>
